...
# Define a recursive function to calculate the nth Fibonacci number with a twist
# The function takes two arguments, n and k
def fib(n, k):
    # Base case: if n is 1 or 2, return 1
    if n == 1 or n == 2:
        return 1
    # Recursive case: return the sum of the (n-1)th and (n-2)th Fibonacci numbers,
    # multiplied by the constant k for the (n-2)th Fibonacci number
    else:
